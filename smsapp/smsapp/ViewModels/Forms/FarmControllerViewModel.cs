...
namespace smsapp
{
    ...
    /// </summary>
    public class FarmControllerViewModel : BaseViewModel
    {
        ...
        /// The users list
        /// </summary>
        public ObservableCollection<Farm> Farms { set; get; }
        ...
        /// Current user
        /// </summary>
        public Farm CurrentFarm { set; get; }
        ...
        #region Constructors
        public FarmControllerViewModel(Farm farm)
        {
            CurrentFarm = farm;
            IsEditing = true;
            Initialize();
        }
        public FarmControllerViewModel()
        {
        ...
        private void Initialize()
        {
            ...
            AddUserCommand = new RelayCommand(async () =>
            {
                ...
                await IoC.Database.AddFarmAsync(CurrentFarm);
            ...
            SaveEditsCommand = new RelayCommand(async () =>
            {
                ...
                PopupContent.PopupType = PopupType.Wait;
                IsPopupVisible = true;
                await IoC.Database.EditFarm(CurrentFarm);
                // Return everything to initial state
                PopupContent.PopupType = PopupType.Success;
            });
            CloseCommand = new RelayCommand(() =>
            {
                MainWindowViewModel.Instance.IsFarmControllerVisible = !MainWindowViewModel.Instance.IsFarmControllerVisible;
            });
